...
namespace TareasMVC.Controllers
{
    public class UsuariosController: Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel modelo)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "Nombre de usuario o pasword incorrecto");
                return View(modelo);
            }
        ...
        public async Task<IActionResult> HacerAdmin(string email)
        {
            ...
            return RedirectToAction("Listado", routeValues: new { mensaje = "Rol asignado crrectamente a" + email });
        }
        ...
        public async Task<IActionResult> RemoverAdmin(string email)
        {
            ...
            return RedirectToAction("Listado", routeValues: new { mensaje = "Rol removido crrectamente a" + email });
        }
    }
}
